...
- [] Make coins farther than 3 cells away grayed out, value is not visible (cannot interact with this)
- [] If the coin is within the 3 cell range, make it blue with it's value visible (can interact with this)
